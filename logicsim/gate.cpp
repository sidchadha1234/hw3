...
//notgate object same as previous gates with one less input wire
NotGate::NotGate(Wire* a, Wire* o) : Gate(1,o)
{
    wireInput(0,a);
}

//notgate object same as previous gates with one less input wire and specified parameters

Event* NotGate::update(uint64_t current_time)//take a further look at
{
